        ...
        for i, sentence in enumerate(utterance['tokenized_speech']):
            ...
            for word, pos, _ in sentence:
                ...
                if match:
                    ...
                    yield {'title': title, 'speaker': utterance['speaker'], 'match': word, 'sentence': highlightedText}
                    break
    ...
    for title, utterance in _iterateTexts(root):
        ...
        for i, sentence in enumerate(utterance['speech']):
            ...
            if match:
                ...
                yield {'title': title, 'speaker': utterance['speaker'], 'match': matchTxt, 'sentence': highlightedText}
